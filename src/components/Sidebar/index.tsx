            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Calendar --> */}
               ...
               <li>
                <NavLink
                  to="/customer"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('customer') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
              ...
              {/* <!-- Menu Item Transection --> */}
              <li>
                <NavLink
                  to="/transection"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('transection') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
              ...
              <li>
                <NavLink
                  to="/reports"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('reports') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
              ...
              {/* <!-- Menu Item Customer Support --> */}
              <li>
                <NavLink
                  to="/customer-support"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('customer-support') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
